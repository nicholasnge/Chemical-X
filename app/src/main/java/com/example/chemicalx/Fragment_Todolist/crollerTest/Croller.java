...
public class Croller extends View {
    ...
    private void initXMLAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, com.example.chemicalx.R.styleable.Croller);

        setEnabled(a.getBoolean(com.example.chemicalx.R.styleable.Croller_enabled, true));
        setProgress(a.getInt(com.example.chemicalx.R.styleable.Croller_start_progress, 1));
        setLabel(a.getString(com.example.chemicalx.R.styleable.Croller_label));

        setBackCircleColor(a.getColor(com.example.chemicalx.R.styleable.Croller_back_circle_color, backCircleColor));
        setMainCircleColor(a.getColor(com.example.chemicalx.R.styleable.Croller_main_circle_color, mainCircleColor));
        setIndicatorColor(a.getColor(com.example.chemicalx.R.styleable.Croller_indicator_color, indicatorColor));
        setProgressPrimaryColor(a.getColor(com.example.chemicalx.R.styleable.Croller_progress_primary_color, progressPrimaryColor));
        setProgressSecondaryColor(a.getColor(com.example.chemicalx.R.styleable.Croller_progress_secondary_color, progressSecondaryColor));

        setBackCircleDisabledColor(a.getColor(com.example.chemicalx.R.styleable.Croller_back_circle_disable_color, backCircleDisabledColor));
        setMainCircleDisabledColor(a.getColor(com.example.chemicalx.R.styleable.Croller_main_circle_disable_color, mainCircleDisabledColor));
        setIndicatorDisabledColor(a.getColor(com.example.chemicalx.R.styleable.Croller_indicator_disable_color, indicatorDisabledColor));
        setProgressPrimaryDisabledColor(a.getColor(com.example.chemicalx.R.styleable.Croller_progress_primary_disable_color, progressPrimaryDisabledColor));
        setProgressSecondaryDisabledColor(a.getColor(com.example.chemicalx.R.styleable.Croller_progress_secondary_disable_color, progressSecondaryDisabledColor));

        setLabelSize(a.getDimension(com.example.chemicalx.R.styleable.Croller_label_size, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                labelSize, getResources().getDisplayMetrics())));
        setLabelColor(a.getColor(com.example.chemicalx.R.styleable.Croller_label_color, labelColor));
        setlabelDisabledColor(a.getColor(com.example.chemicalx.R.styleable.Croller_label_disabled_color, labelDisabledColor));
        setLabelFont(a.getString(com.example.chemicalx.R.styleable.Croller_label_font));
        setLabelStyle(a.getInt(com.example.chemicalx.R.styleable.Croller_label_style, 0));
        setIndicatorWidth(a.getFloat(com.example.chemicalx.R.styleable.Croller_indicator_width, 7));
        setIsContinuous(a.getBoolean(com.example.chemicalx.R.styleable.Croller_is_continuous, false));
        setProgressPrimaryCircleSize(a.getFloat(com.example.chemicalx.R.styleable.Croller_progress_primary_circle_size, -1));
        setProgressSecondaryCircleSize(a.getFloat(com.example.chemicalx.R.styleable.Croller_progress_secondary_circle_size, -1));
        setProgressPrimaryStrokeWidth(a.getFloat(com.example.chemicalx.R.styleable.Croller_progress_primary_stroke_width, 25));
        setProgressSecondaryStrokeWidth(a.getFloat(com.example.chemicalx.R.styleable.Croller_progress_secondary_stroke_width, 10));
        setSweepAngle(a.getInt(com.example.chemicalx.R.styleable.Croller_sweep_angle, -1));
        setStartOffset(a.getInt(com.example.chemicalx.R.styleable.Croller_start_offset, 30));
        setMax(a.getInt(com.example.chemicalx.R.styleable.Croller_max, 25));
        setMin(a.getInt(com.example.chemicalx.R.styleable.Croller_min, 1));
        deg = min + 2;
        setBackCircleRadius(a.getFloat(com.example.chemicalx.R.styleable.Croller_back_circle_radius, -1));
        setProgressRadius(a.getFloat(com.example.chemicalx.R.styleable.Croller_progress_radius, -1));
        setAntiClockwise(a.getBoolean(com.example.chemicalx.R.styleable.Croller_anticlockwise, false));
        a.recycle();
    }
